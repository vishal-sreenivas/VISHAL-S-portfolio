            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  <a href="mailto:vishal.s.offical@gmail.com" className="text-muted hover:text-light transition-colors">
                    vishal.s.offical@gmail.com
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <a href="tel:+919633760494" className="text-muted hover:text-light transition-colors">
                    +91 9633760494
                  </a>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <div className="flex gap-3 mt-2">
                    {/* GitHub */}
                    <a href="https://github.com/vishal-sreenivas" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
                    ...
                    {/* LinkedIn */}
                    <a href="https://www.linkedin.com/in/vishal-sreenivas-770a72271" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity">
